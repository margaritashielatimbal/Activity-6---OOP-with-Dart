...
void testAdd(var testLib){
  testLib.addBook("Introduction to Algorithms", "Thomas H. Cormen", "Computer Science", "978-0-26203-384-8");
  testLib.addBook("Sophie's World", "Jostein Gaarder", "Philosophy", "978-1-891830-85-3");
  testLib.addBook("The History of Ancient World", "Susan Wise Bauer", "History", "978-0-39305-974-8");
  testLib.addBook("The Color Purple", "Alice Walker", "Art and Recreation", "978-0-156092-835-6");
  testLib.addBook("The C Programming Language", "Brian W. Kerninghan", "Computer Science", "978-0-13110-163-0");
  testLib.addBook("Democracy: A Life", "Paul Cartledge", "History", "978-0-190866-271-3");
  testLib.addBook("Pearl Jam Twenty", "Pearl Jam", "Art and Recreation", "978-1-439169-377-7");
  testLib.addBook("The Universe", Bhatnagar, P, L.", "Pure Science", "978-1-256357-57-1");
  testLib.addBook("A Preparation for Science", "Richard Gregg", "Pure Science", "978-1-11071-560-5");
  testLib.addBook("Churchill: Walking with Destiny", "Andrew Roberts", "History", "978-1-10198-099-6");
  testLib.addBook("The Algorithm Design Manual", "Steven S. Skiena", "Computer Science", "978-0-38794-860-7");
  testLib.addBook("Meditations", "Marcus Aurelius", "Philosophy", "978-0-81296-825-5");
  testLib.addBook("Introducing Science", "Alan Isaacs", "Pure Science", "978-0-14020-562-6");
  testLib.addBook("Man's Search for Meaning", "Viktor Frankl", "Philosophy", "978-0-807031-429-5");
  testLib.addBook("Code Complete", "Steve McConnell", "Computer Science", "978-7-12103-362-9");
}
